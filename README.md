...
```bash
brew tap maydali28/tap
brew install --cask claudewatch
```

#### Direct download

Download the `.dmg` from the [latest release](https://github.com/maydali28/claudewatch/releases/latest).
...
Download `ClaudeWatch-Setup.exe` from the [latest release](https://github.com/maydali28/claudewatch/releases/latest). The installer uses Squirrel, so updates apply silently in the background.
